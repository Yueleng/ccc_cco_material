...
# Now whenever your tint factor is > T,
...
for i in range(n):
    # ytoi[rects[i][1]] = ytoi[rects[0][1]] = ytoi[11] = 1
    # ytoi[rects[i][3]] = ytoi[rects[0][3]] = ytoi[15] = 4
	for j in range(ytoi[rects[i][1]],ytoi[rects[i][3]]):
        # rects[i][0]: x coordinate, left
        # xtoi[rects[i][0]]: (x coordinate, left) ordering

        # rects[i][2]: x coordinate, right
        # xtoi[rects[i][2]]: (x coordinate, right) ordering
