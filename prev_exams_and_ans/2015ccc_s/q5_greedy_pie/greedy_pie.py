...
# pies, so we add three more variables to the state, m for number of pies
...
#       i.e. previous state already stops the process, thus this state does not exist
#
...
# list that actually calculate the states. Using one list and multiplying 
...
# loop through every possible valid state, 
# in the order where all of the prerequisite states
